...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__orderBy_pipe__ = __webpack_require__("../../../../../src/app/core/layout/inner-pages/chats/orderBy.pipe.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ChatsModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_16__orderBy_pipe__["a" /* OrderByPipe */]
        ]
    })
], ChatsModule);
...
// module
exports.push([module.i, "#contactListTable tr td:nth-child(2n){\n    min-width: 122px;\n}\n.searchbox {\n    margin-bottom: 20px;\n    border-radius: 20px;\n    border: 1px solid #3c8dbc;\n    box-shadow: 0px 0px 4px 1px #3c8dbc75;\n    width: calc(100% - 54px);\n    height: 30px;\n    outline: none;\n    padding: 16px;\n}\n\n@media screen and (max-width:1024px){\n    .box{\n        overflow-x: scroll;\n    }\n}", ""]);
...
// module
exports.push([module.i, "#chatList tr td:nth-child(n+2){\n    min-width: 100px;\n}\n#chatList tr td:nth-child(n+5){\n    min-width: 105px;\n}\n#chatList tr td button i{\n    padding-right: 7px;\n}\n.searchbox {\n    margin-bottom: 20px;\n    border-radius: 20px;\n    border: 1px solid #3c8dbc;\n    box-shadow: 0px 0px 4px 1px #3c8dbc75;\n    width: calc(100% - 54px);\n    height: 30px;\n    outline: none;\n    padding: 16px;\n}\n\n@media screen and (max-width:1024px){\n    .box{\n        overflow-x: scroll;\n    }\n}\n", ""]);
...
/***/ "../../../../../src/app/core/layout/inner-pages/chats/orderBy.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
