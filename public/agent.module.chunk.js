...
var CreateAgentComponent = (function () {
    ...
    CreateAgentComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.data
            ...
            if (_this.editMode) {
                ...
                _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_6__store_agent_agent_actions__["w" /* GetToEditAgentAttempt */]({ agentId: _this.userId }));
        ...
        this.afterLoginSubscription = this.store.select('afterLogin')
            ...
            if (data) {
                ...
                _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_6__store_agent_agent_actions__["y" /* ResetAgentForm */]());
    ...
    CreateAgentComponent.prototype.onSubmit = function (form) {
        ...
        if (this.editMode) {
            ...
            this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_6__store_agent_agent_actions__["k" /* EditAgentAttempt */](__assign({}, data)));
            /** Loader Show/Hide */
            ...
            /** Create Agent */
            this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_6__store_agent_agent_actions__["g" /* AddAgentAttempt */](form.value));
            /** Loader Show/Hide */
            this.store.select('alert')
                .map(function (data) { return data; })
                .subscribe(function (data) {
...
var ListAgentComponent = (function () {
    ...
    ListAgentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__store_agent_agent_actions__["u" /* GetAgentListAttempt */]());
        this.authState = this.store.select('auth');
        this.page = 1;
        this.companySearch = '';
        this.afterLoginState = this.store.select('afterLogin');
        this.authSubscription = this.store.select('auth')
            ...
            if (data.isSuperAdmin) {
                _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__store_agent_agent_actions__["v" /* GetCompanyListAttempt */]({ userId: data.token }));
            }
        });
    ...
    ListAgentComponent.prototype.blockUser = function (user_id) {
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__store_agent_agent_actions__["h" /* BlockAgentAttempt */]({ userId: user_id }));
    };
    ListAgentComponent.prototype.UnblockUser = function (user_id) {
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__store_agent_agent_actions__["z" /* UnblockAgentAttempt */]({ userId: user_id }));
    };
