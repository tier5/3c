...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_angular2_multiselect_dropdown_angular2_multiselect_dropdown__ = __webpack_require__("../../../../angular2-multiselect-dropdown/angular2-multiselect-dropdown.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_ngx_sweetalert2__ = __webpack_require__("../../../../ngx-sweetalert2/index.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AgentModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_14_angular2_multiselect_dropdown_angular2_multiselect_dropdown__["a" /* AngularMultiSelectModule */]
        ],
        declarations: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_15_ngx_sweetalert2__["a" /* SweetAlertService */]]
    })
], AgentModule);
...
var CreateAgentComponent = (function () {
    ...
    function CreateAgentComponent(store, activatedRoute, cdr, router, modalService, deptStore) {
        ...
        this.dropdownSettings = {}; /** dropDown settings blank obj*/
    ...
    CreateAgentComponent.prototype.ngOnInit = function () {
        ...
        this.updateAgent = this.store.select('afterLogin')
            ...
            if (Object.keys(agent).length !== 0) {
                ...
                _this.agent.departmentId = agent.departments;
        ...
        this.activatedRoute.data
            ...
            if (_this.editMode) {
                ...
                _this.adminUserId = 0;
                _this.agent.firstName = '';
                _this.agent.lastName = '';
                _this.agent.userName = '';
                _this.agent.email = '';
                _this.agent.phone = '';
                _this.agent.departmentId = [];
                _this.adminName = '';
                _this.isemailNotification = true;
                _this.isPhoneNotification = true;
            }
        });
        ...
        this.afterLoginSubscription = this.store.select('department')
            ...
            if (data) {
                ...
                if (data.newDepartmentId > 0 && _this.createDeptSuccess) {
                    ...
                    _this.agent.departmentId = oldArray.concat(newObj_1);
                    _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_7__store_department_department_actions__["s" /* GetAgentDepartmentListAttempt */]({ userId: _this.agent.parentId }));
                }
            }
        });
    };
    ...
    CreateAgentComponent.prototype.deptChanged = function (id) {
        ...
        if (id === '99999991999999') {
            var element = document.getElementById('createDepartment');
            element.click();
        }
    };
...
var ListAgentComponent = (function () {
    /** Service injection */
    function ListAgentComponent(store, router, orderPipe, _swal2) {
        this.store = store;
        this.router = router;
