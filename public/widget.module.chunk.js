...
var CreateWidgetComponent = (function () {
    ...
    CreateWidgetComponent.prototype.ngOnInit = function () {
        ...
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_6__store_widget_widget_actions__["q" /* GetTimeZoneListAttempt */]());
        ...
        this.activatedRoute.data.subscribe(function (data) {
            ...
            if (_this.editMode) {
                ...
                _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_6__store_widget_widget_actions__["s" /* GetWidgetToEditAttempt */]({ widgetId: _this.widgetId }));
        ...
        this.afterLoginSubscription = this.store.select('afterLogin')
            ...
            if (data) {
                _this.form.reset();
                _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_6__store_widget_widget_actions__["u" /* ResetWidgetForm */]());
    ...
    CreateWidgetComponent.prototype.buyNumber = function (areaCode, contains) {
        ...
        if (areaCode || contains) {
            ...
            this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_6__store_widget_widget_actions__["p" /* GetNumberListAttempt */]({ areaCode: areaCode, contains: contains }));
...
var ListWidgetComponent = (function () {
    ...
    ListWidgetComponent.prototype.ngOnInit = function () {
        ...
        this.authSubscription = this.store.select('auth')
            .subscribe(function (data) {
            if (data.isAdmin) {
                _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__store_widget_widget_actions__["r" /* GetWidgetListAttempt */]({ userId: data.userId }));
            }
            else {
                _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__store_widget_widget_actions__["r" /* GetWidgetListAttempt */]({}));
            }
        });
        this.afterLoginState = this.store.select('afterLogin');
