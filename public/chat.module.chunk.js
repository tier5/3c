...
var OngoingComponent = (function () {
    function OngoingComponent(store, chatService, activatedRoute, router, _swal2) {
        this.store = store;
            ...
            if (result) {
                ...
                switch (status) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        _this.chatService.takeAction(_this.transferData);
