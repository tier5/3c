...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.pendingChat = function (chats) {
        return chats.filter(function (chat) { return chat.status == 1 || chat.status == 6; }).length;
    };
    DashboardComponent.prototype.ongoingChat = function (chats) {
        return chats.filter(function (chat) { return chat.status == 2; }).length;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__orderBy_pipe__ = __webpack_require__("../../../../../src/app/core/layout/inner-pages/dashboard/orderBy.pipe.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
DashboardModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__orderBy_pipe__["a" /* OrderByPipe */]
        ]
    })
], DashboardModule);
